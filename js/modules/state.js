export const state = {
  ...
  homeActiveTab: "gerais", // Define a aba ativa na tela inicial (gerais ou patrimoniais)
  modoVisualizacao: "lista", // Define se a Home mostra "lista" de transações ou "gestao-patrimonio"
